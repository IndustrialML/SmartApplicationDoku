...
**Appendix:** In some cases you might not want to worry about having to take care about hosting a webservice yourself, but rather want to focus on the machine learning part, as models and preprocessing is getting more complex. In this case you can try one of the many provided applicable environments, like [Azure Machine Learning Studio](https://studio.azureml.net/) or [Azure Machine Learning Services](https://docs.microsoft.com/en-us/azure/machine-learning/preview/). We included [examples](https://github.com/IndustrialML/experiments/tree/master/Azure_ML) for the Azure ML Services in our benchmark test, of which the results will be evaluated at the final chapter of this paper.
